...
class MainMenuState extends MusicBeatState
{
    ...
    var optionShit:Array<String> = ['story_mode', 'freeplay', 'credits', 'awards', 'options'];
	...
	var itemCoords:Array<Array<Int>> = [
        [100, 0],
        [200, 200],
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			menuItem.x = itemCoords[i][0];
			menuItem.y = itemCoords[i][1];
		}
